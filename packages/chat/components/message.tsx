            ...
            {message.parts?.map((part, index) => {
              ...
              if (type === 'tool-requestSuggestions') {
                ...
                if (state === 'input-available') {
                  ...
                  return (
                    <div key={toolCallId}>
                      <DocumentToolCall type="request-suggestions" args={input} isReadonly={isReadonly} />
                    </div>
                  );
                }
                ...
                if (state === 'output-available') {
                  ...
                  return (
                    <div key={toolCallId}>
                      <DocumentToolResult type="request-suggestions" result={output} isReadonly={isReadonly} />
                    </div>
                  );
                }
              }
