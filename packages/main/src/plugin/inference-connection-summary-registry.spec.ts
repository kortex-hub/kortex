  ...
  getProviderInfosMock.mockReturnValue([
    {
      ...
      inferenceConnections: [
        { id: 'conn-0', name: 'conn1', type: 'cloud', status: 'started', models: [{ label: 'gpt-4' }] },
        { id: 'conn-1', name: 'conn2', type: 'cloud', status: 'stopped', models: [{ label: 'gpt-3.5' }] },
      ],
  ...
  getProviderInfosMock.mockReturnValue([
    {
      ...
      internalId: 'multi-1',
      inferenceConnections: [
        { id: 'cloud-0', name: 'cloud-conn', type: 'cloud', status: 'started', models: [{ label: 'model-a' }] },
      ],
      inferenceProviderConnectionCreation: true,
