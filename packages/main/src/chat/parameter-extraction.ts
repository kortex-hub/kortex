...
export class ParameterExtractor {
   ...
   */
  public extractFromMCPToolCalls(messages: UIMessage[]): FlowParameter[] {
  ...
  private extractParametersFromMessage(message: UIMessage): FlowParameter[] {
  ...
  private extractParametersFromTool(tool: DynamicToolUIPart): FlowParameter[] {
  ...
  private createParameter(name: string, value: unknown, toolName: string): FlowParameter {
