...
import { CursorProviderSymbol, ExtensionContextSymbol, SecretStorageSymbol } from '/@/inject/symbol';
...
export class InversifyBinding {
  ...
  public async initBindings(): Promise<Container> {
    ...
    this.#container.bind(CursorProviderSymbol).toConstantValue(this.#provider);
    ...
    await this.#container.getAsync(CursorInferenceManager);
